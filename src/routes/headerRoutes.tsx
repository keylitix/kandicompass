...
const headers: RouteProps[] = [
	...
	{ path: dashboardPagesMenu.BeadManagement.path, element: null },
	{ path: dashboardPagesMenu.UserMangemet.path, element: null },
	// { path: dashboardPagesMenu.AnalyticsAndReports.path, element: null },
