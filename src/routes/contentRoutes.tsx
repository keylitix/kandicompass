...
const Kindy_project = {
	DASHBOARD: lazy(() => import('../pages/Kindy-project/Dashboard/DashboardPage')),
	BeadManagement: lazy(() => import('../pages/Kindy-project/BeadManagement/BeadManagement')),
	USERMANGEMENT: lazy(() => import('../pages/Kindy-project/UserManagement/UserManagement')),
    ANALYTICREPORT:lazy(() => import('../pages/Kindy-project/AnlayticReport/AnlayticReport')),
	SETTINGANDSECURITY:lazy(() => import('../pages/Kindy-project/Security/Security')),
	ROLEMANAGEMENT:lazy(() => import('../pages/Kindy-project/RoleManagement/RoleManagement')),
	THRED:lazy(() => import('../pages/Kindy-project/Thred/Thred')),
};
const SINGLE = {
...
const presentation: RouteProps[] = [
	 ...
	 */
	{
		...
		element: <Kindy_project.DASHBOARD />,
	},
	{
		path: dashboardPagesMenu.BeadManagement.path,
		element: <Kindy_project.BeadManagement />
	},
	{
		path: dashboardPagesMenu.UserMangemet.path,
		element: <Kindy_project.USERMANGEMENT />,
	},
	// {
	// 	path: dashboardPagesMenu.AnalyticsAndReports.path,
	// 	element: <Kindy_project.ANALYTICREPORT />,
	// },
	// {
	// 	path: dashboardPagesMenu.SecurityAndSettings.path,
	// 	element: <Kindy_project.SETTINGANDSECURITY />,
	// },
	// {
	// 	path: dashboardPagesMenu.RoleManagement.path,
	// 	element: <Kindy_project.ROLEMANAGEMENT />,
	// },
	{
		path: dashboardPagesMenu.Thred.path,
		element: <Kindy_project.THRED />,
	},
	{
