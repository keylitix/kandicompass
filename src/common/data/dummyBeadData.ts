...
const beadsData = [
  {
    id: 1,
    name: 'Bead 1',
    email: 'bead1@example.com',
    type: 'Active',
    membershipDate: dayjs('2022-05-01'),
    balance: 50.5,
    payout: PAYMENTS.PAYPAL.name, // Updated to use enum PAYMENTS.PAYPAL.name
    isOnline: true,
  ...
  },
  {
    id: 2,
    name: 'Bead 2',
    email: 'bead2@example.com',
    type: 'Inactive',
    membershipDate: dayjs('2021-03-15'),
    balance: 120.75,
    payout: PAYMENTS.SWIFT.name, // Updated to use enum PAYMENTS.PAYPAL.name
    isOnline: false,
  ...
  },
  {
    id: 4,
    name: 'Bead 4',
    email: 'bead4@example.com',
    type: 'Inactive',
    membershipDate: dayjs('2021-09-12'),
    balance: 45.2,
    payout: PAYMENTS.PAYPAL.name, // Accessing the 'name' property of PAYMENTS.PAYPAL
    isOnline: false,
  ...
  
  {
    id: 5,
    name: 'Bead 5',
    email: 'bead5@example.com',
    type: 'Active',
    membershipDate: dayjs('2023-02-05'),
    balance: 80.9,
    payout: PAYMENTS.SWIFT.name, // Accessing the 'name' property of PAYMENTS.PAYPAL
    isOnline: true,
  ...
  
  {
    id: 6,
    name: 'Bead 6',
    email: 'bead6@example.com',
    type: 'Active',
    membershipDate: dayjs('2022-11-20'),
    balance: 110.3,
    payout: PAYMENTS.PAYONEER.name, // Accessing the 'name' property of PAYMENTS.PAYPAL
    isOnline: true,
